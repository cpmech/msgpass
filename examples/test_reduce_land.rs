...
fn main() -> Result<(), StrError> {
    ...
    comm.reduce_i32(0, &mut y_i32, &x_i32, MpiOp::Land)?;
    comm.reduce_i64(0, &mut y_i64, &x_i64, MpiOp::Land)?;
    comm.reduce_u32(0, &mut y_u32, &x_u32, MpiOp::Land)?;
    comm.reduce_u64(0, &mut y_u64, &x_u64, MpiOp::Land)?;
    comm.reduce_usize(0, &mut y_usz, &x_usz, MpiOp::Land)?;
