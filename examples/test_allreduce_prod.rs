...
fn main() -> Result<(), StrError> {
    ...
    comm.allreduce_i32(&mut y_i32, &x_i32, MpiOp::Prod)?;
    comm.allreduce_i64(&mut y_i64, &x_i64, MpiOp::Prod)?;
    comm.allreduce_u32(&mut y_u32, &x_u32, MpiOp::Prod)?;
    comm.allreduce_u64(&mut y_u64, &x_u64, MpiOp::Prod)?;
    comm.allreduce_usize(&mut y_usz, &x_usz, MpiOp::Prod)?;
    comm.allreduce_f32(&mut y_f32, &x_f32, MpiOpx::Prod)?;
    comm.allreduce_f64(&mut y_f64, &x_f64, MpiOpx::Prod)?;
