...
fn main() -> Result<(), StrError> {
    ...
    comm.allreduce_i32(&mut y_i32, &x_i32, MpiOp::Sum)?;
    comm.allreduce_i64(&mut y_i64, &x_i64, MpiOp::Sum)?;
    comm.allreduce_u32(&mut y_u32, &x_u32, MpiOp::Sum)?;
    comm.allreduce_u64(&mut y_u64, &x_u64, MpiOp::Sum)?;
    comm.allreduce_usize(&mut y_usz, &x_usz, MpiOp::Sum)?;
    comm.allreduce_f32(&mut y_f32, &x_f32, MpiOpx::Sum)?;
    comm.allreduce_f64(&mut y_f64, &x_f64, MpiOpx::Sum)?;
